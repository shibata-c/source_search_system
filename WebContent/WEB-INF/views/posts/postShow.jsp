            ...
            <c:when test="${post != null}">
                ...
                <table>
                    <tbody>
                        <tr>
                            <th>氏名</th>
                            <td class="show_td"><c:out value="${post.employee.name}" /></td>
                        </tr>
                        <tr>
                            <th>日付</th>
                            <td class="show_td"><fmt:formatDate value="${post.post_date}" pattern="yyyy-MM-dd" /></td>
                        </tr>
                        <tr>
                            <th>内容</th>
                            <td class="show_td">
                        ...
                        <tr>
                            <th>更新日時</th>
                            <td class="show_td">
                                <fmt:formatDate value="${post.updated_at}" pattern="yyyy-MM-dd HH:mm:ss" />
                            </td>
                        </tr>
                        <tr>
